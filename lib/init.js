  ...
  if (tools.includes('windsurf')) {
    results.push(
      Object.assign(
        { path: '.windsurfrules' },
        copyFile(
          path.join(TEMPLATES_DIR, 'adapters', 'windsurfrules.tmpl'),
  ...
  if (tools.includes('cline')) {
    results.push(
      Object.assign(
        { path: '.clinerules' },
        copyFile(
          path.join(TEMPLATES_DIR, 'adapters', 'clinerules.tmpl'),
  ...
  if (tools.includes('git') && isGit) {
    ...
    results.push(
      Object.assign(
        ...
        copyFile(
          path.join(TEMPLATES_DIR, 'adapters', 'git-hooks', 'pre-commit.tmpl'),
          hookDest,
          vars,
          opts
        )
