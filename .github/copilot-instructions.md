...
- `.agent-room/skills/` — brainstorming, closing-the-loop, code-review, commit-changes, implement-plan, integration-testing, iterate-plan, release-management, research-codebase, systematic-debugging, test-driven-development, validate-plan, verification-before-completion, writing-plans. Follow these as procedures,
  not suggestions.
